...
#' Wasserstein Polarization Index between the observed measure and the maximally
#' separated measure with (1-alpha)100% confidence intervals.
#'
#'
...
Ip_pol <- function(obs, min, max, q, wp=2, alpha=0.05, weights=rep(c(1/length(obs)), length(obs))){
